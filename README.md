...
helm install --name awx01 ./awx --namespace dev-infra --set service.type=LoadBalancer,awx_task.image.tag=6.1.0,awx_web.image.tag=6.1.0,global.hosts.externalIP=30.14.80.52
```
